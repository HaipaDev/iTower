    ...
    void FixedUpdate(){
        for(var i=0;i<transform.childCount;i++){
            ...
            if(dir==dir.up||dir==dir.down){
                transform.GetChild(i).position=new Vector2(transform.GetChild(i).position.x,pos+strength*dirM);//Move
                ...
                transform.GetChild(i).position=new Vector2(pos+strength*dirM,transform.GetChild(i).position.y);
